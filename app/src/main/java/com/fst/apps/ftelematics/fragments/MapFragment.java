		...
		handler.post(new Runnable() {
            ...
            public void run() {
                ...
                if (t < 1.0) {
                    ...
                    if(status.equalsIgnoreCase("0")){
                        marker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.ic_marker_nw));
                    }else if(status.equalsIgnoreCase("61714")){
                        marker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.ic_marker_moving));
                    }else if(status.equalsIgnoreCase("61715")){
                        marker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.ic_marker_stop));
                    }else if(status.equalsIgnoreCase("61716")){
                        marker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.ic_marker_dormant));
                    }
                }
			}
		});

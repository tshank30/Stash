...
public class IgnitionAlertsFragment extends Fragment{
	...
	private static final String TAG=AppConstants.ALERT_TYPES.Ignition.name();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		objList.put("alertType", AlertTypes.IGNITION);
		...
		alerts=db.getAlertsByAlertType(AlertTypes.IGNITION,sf.getUserId());

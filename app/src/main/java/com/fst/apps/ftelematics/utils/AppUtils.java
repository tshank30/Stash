...
import com.fst.apps.ftelematics.service.RefreshParkingServiceOreo;
import com.fst.apps.ftelematics.service.RefreshServiceForParking;
...
//			if (!ActivityCompat.shouldShowRequestPermissionRationale(activity, permission))
    ...
    public void setParkingAlarm() {
        ...
        boolean alarmUp = (PendingIntent.getService(context, 196,
                new Intent(context, RefreshServiceForParking.class),
        ...
        if (alarmUp) {
            ...
            if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                Intent intent = new Intent(context, RefreshParkingServiceOreo.class);
                pendingIntent = PendingIntent.getForegroundService(context, 196, intent, PendingIntent.FLAG_CANCEL_CURRENT);
            } else {
                Intent intent = new Intent(context, RefreshServiceForParking.class);
                pendingIntent = PendingIntent.getService(context, 196, intent, PendingIntent.FLAG_CANCEL_CURRENT);
            }
